...
extern osSemaphoreId usarrtBinaryHandle;
/* USER CODE END EV */
...
void LPUART1_IRQHandler(void)
{
  ...
  //IDLE FLAG STATE
    ...
    if(usarrtBinaryHandle != NULL){
      xSemaphoreGiveFromISR(usarrtBinaryHandle,&xHigherPriorityTaskWoken); //释放信号
      portYIELD_FROM_ISR(xHigherPriorityTaskWoken);//如果�?要的话进行一次任务切�?
    }    	
